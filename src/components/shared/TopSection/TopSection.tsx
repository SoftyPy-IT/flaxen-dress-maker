...
import bgimg from "../../../assets/images/cover/2.png";
    ...
    <>
      <div className="relative ">
        {/* <div className="absolute inset-0 -z-10">
          <Image src={bgimg} alt="Background" fill className="h-full" priority />
        </div> */}
        <div className="flex items-center justify-between px-2  bg-white border rounded-md h-[150px] shadow-md">
          <div className="flex items-center gap-4">
            <Image src={flaxen} alt="Company Logo" width={60} height={60} />
            <div>
              <h1 className="">Flaxen Dress Maker Ltd</h1>
              <p className="text-sm">
                <span className="font-bold"> Factory:</span> Meghdubi,
                Gazipur-1700, Bangladesh
              </p>
              <p className="text-sm">
                <span className="font-bold">Corporate Office:</span> House# 35,
                Road# 9, Sector# 15, Uttara, Dhaka
              </p>
            </div>
          </div>
