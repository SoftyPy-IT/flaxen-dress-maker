...
import CuttingUSendModal from "./CuttingUSendModal";
...
const CuttingUnit = () => {
  ...
  return (
    <>
                ...
                {rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell align="center">
                      ...
                      <IconButton
                        href={`/super-admin/cutting-unit/preview/${row.id}`}
                      >
                        <VisibilityIcon fontSize="small" color="primary" />
                      </IconButton>
                      <IconButton href={`/super-admin/cutting-unit/${row.id}`}>
      ...
      {open && <CuttingUSendModal open={open} setOpen={handleClose} />}
    </>
  );
};

export default CuttingUnit;
